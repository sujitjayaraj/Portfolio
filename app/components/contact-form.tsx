...
export default function ContactForm() {
    ...
    async function handleSendMail(e: MouseEvent<HTMLButtonElement>){
        e.preventDefault();
    ...
    return (
        <div>
            ...
            <div className={"max-w-3xl text-white rounded-lg border border-[#464c6a] p-3 lg:p-5"}>
                <p className={"text-sm text-[#d3d8e8]"}>{"Please feel free to reach out to me with any questions or concerns."}</p>
