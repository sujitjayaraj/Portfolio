import { personalInfo } from "@/app/utils/info/personal";
            ...
            <div className={"grid grid-cols-1 items-start lg:grid-cols-2 lg:gap-12 gap-y-8"}>
                <div className={"order-2 lg:order-1 flex flex-col items-start justify-center p-2 pb-20 md:pb-10 lg:pt-10"}>
                    ...
                    <div className={"my-12 flex items-center gap-5"}>
                        <Link href={personalInfo.social.github}
                              target={"_blank"}
                              className={"transition-all text-pink-500 hover:scale-125 duration-300"}>
                            <BsGithub size={30} />
                        </Link>
                        <Link href={personalInfo.social.linkedin}
                              target={"_blank"}
                              className={"transition-all text-pink-500 hover:scale-125 duration-300"}>
                            <BsLinkedin size={30} />
                        </Link>
                        <Link href={personalInfo.social.leetcode}
                              target={"_blank"}
                              className={"transition-all text-pink-500 hover:scale-125 duration-300"}>
                            <SiLeetcode size={30} />
                        </Link>
                        <Link href={personalInfo.social.twitter}
                              target={"_blank"}
                              className={"transition-all text-pink-500 hover:scale-125 duration-300"}>
